...
<style>
body{background:#fff;margin:0;padding:0;text-align:center;font-family: "Microsoft YaHei" ! important;font-size:14px;color:#666666;overflow:hidden}
.error_page{width:600px;height:400px;padding:50px;margin:auto;}
