...
<div data-options="region:'west'" style="width:220px;background:#2D75C6;oveflow-x:hidden;">
	<div id="westMenu" class="west-menu" style="overflow-y:scroll; width:250px;padding-bottom:50px;"></div>
</div>
...
<div data-options="region:'south'" style="height:36px;display:none;"><div id="footer">版权所有：大博（武汉）科技</div></div>
<script>
$(function(){
	resize();
	loadMenuTree();
	...
	// $('.logout').tooltip({
	// 	position: 'bottom',
	// 	content: '<span style="color:#fff">退出</span>',
	// 	onShow: function(){
	// 		$(this).tooltip('tip').css({
	// 			backgroundColor: '#666',
	// 			borderColor: '#666'
