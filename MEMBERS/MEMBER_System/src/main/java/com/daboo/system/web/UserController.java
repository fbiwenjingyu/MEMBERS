...
public class UserController extends BaseController {
	...
	public String init(HttpServletRequest request){
		...
		request.setAttribute("initPassword", SysInitConfig.getInstance().get(CfgProp.DABOO_DEFAULTPASSWORD));
	...
	public void initPwd(HttpServletRequest request,PrintWriter out){
		...
		try {
			...
			for(String id:aId){
				...
				sUser.setUserPwd(SysInitConfig.getInstance().get(CfgProp.DABOO_DEFAULTPASSWORD));
