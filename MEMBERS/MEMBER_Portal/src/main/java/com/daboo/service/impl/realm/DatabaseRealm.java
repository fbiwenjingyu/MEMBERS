package com.daboo.service.impl.realm;
...
public class DatabaseRealm extends AuthorizingRealm {
	...
	@Autowired
	private MUserInfoService userInfoService;
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		...
		try {
			MUserInfoModel model = userInfoService.userLoginIn(token.getUsername());
			if (model != null) {
				SimpleAuthenticationInfo sai = new SimpleAuthenticationInfo(userName,SpringSecurityUtils.generatePassword(model.getAccountNo(), model.getPassword()), getName());
